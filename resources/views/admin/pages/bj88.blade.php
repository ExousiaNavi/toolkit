    ...
    <div class="w-full lg:ps-44 mt-2">
        <div class="bg-white border w-full p-2">
            ...
            <div class="flex justify-between items-center p-2 font-bold text-slate-600">
                ...
                <div>
                    <a id="bj88_automate" class="bj88_automate py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                        href="#">
