        ...
        <div class="-m-1.5 overflow-x-auto">
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div
                    ...
                    <!-- Table -->
                    <table id="winrs_table" class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
